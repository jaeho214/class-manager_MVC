...
<%@page import="com.dev.domain.Assignment"%>
...
<div class="container-fluid">
  ...
  <h1 class="h3 mb-0 text-gray-800">과제 수정</h1>
	</div>
	<div class="row">
		<div class="col-lg-12">
			<div class="panel-body">
  			<form action="assignmentUpdate.do" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<label>제목</label>
					<input type="text" class = "form-control" name="title" value="<%out.print(assignment.getTitle());%>">
				</div>
				
				<div class="form-group">
					<label>내용</label>
					<input type="text" class="form-control" name="content" value="<%out.print(assignment.getContent());%>">
				</div>
		
				<div class="form-group">
					<label>기한</label>
					<input type="date" class="form-control" name="deadline" value="<%out.print(assignment.getDeadline());%>">
				</div>
				
				<input type="file" name="files">
				
				<input type="hidden" name="ano" value="<%out.print(assignment.getAno());%>">
				<input type="hidden" name="fno" value="<%out.print(assignment.getFno()); %>">
    			<input type="hidden" name="user_id" value=""> 
    
    			<input type="submit" value="수정완료" class="btn btn-primary"/> 
    			<input type="button" value="취소" onclick="cancel()" class="btn btn-info">
